...
export const ModeControl = (props) => {
    ...
    return (
        <span className={`${styles.group} ${className}`}>
            <Button data-mode="gallery" isIcon={true} isActive={mode === 'gallery'} onClick={() => { handleChange('gallery') }}>
            ...
            <Button data-mode="list" isIcon={true} isActive={mode === 'list'} onClick={() => { handleChange('list') }}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="icon">
